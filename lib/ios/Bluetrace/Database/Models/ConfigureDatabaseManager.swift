//
//  ConfigureDatabaseManager.swift
//  BluetoothDemo
//
...
class ConfigureDatabaseManager {
    ...
    private static var sharedDatabaseManager: ConfigureDatabaseManager?

    static func shared() -> ConfigureDatabaseManager {
        if sharedDatabaseManager == nil {
            sharedDatabaseManager = ConfigureDatabaseManager()
        }

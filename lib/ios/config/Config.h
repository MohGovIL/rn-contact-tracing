...
static long DEFAULT_SCAN_INTERVAL = 10; // seconds
static long DEFAULT_SCAN_DURATION = 50; // seconds
static long DEFAULT_ADVERTISE_INTERVAL = 10; // seconds
static long DEFAULT_ADVERTISE_DURATION = 30; // seconds
